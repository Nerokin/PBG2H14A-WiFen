...
public class Wuerfelfenster extends VBox {
	...
	public void onMouseDragged(MouseEvent ev) {
		...
		/*
		 * double x = ev.getSceneX(); double y = ev.getSceneY();
		 * testMe.relocate(testMe.getLayoutX()+(x-mousex),testMe.getLayoutY() +
		 * (y - mousey));
		 */
		ev.consume();
	}
	...
	public void onMousePressed(MouseEvent ev) {
		...
		/*
		 * mousex = ev.getSceneX(); mousey = ev.getSceneY();
		 */
		ev.consume();
	}
	...
	public void wuerfelDone() {
		 ...
		 * @FXML public void DragDropped(){ System.out.println("DragDropped");
		 * 
		 * }
		 * 
		 * @FXML public void DragEntered(){ System.out.println("DragEntered"); }
		 * 
		 * @FXML public void DragExited(){ System.out.println("DragExited"); }
		 * 
		 * 
		 * @FXML public void MouseDragEntered(){
		 * System.out.println("MouseDragentered");
		 * 
		 * }
		 * 
		 * @FXML public void MouseDragExited(){
		 * System.out.println("MouseDragExited"); }
		 * 
		 * @FXML public void MouseDragOver(){
		 * System.out.println("MouseDragOver"); }
		 * 
		 * @FXML public void MouseDragReleased(){
	...
	/*
	 * EventHandler<MouseEvent> wuerfelOnMousePressedEventHandler = new
	 * EventHandler<MouseEvent>(){
	 * 
	 * @Override public void handle(MouseEvent t){ System.out.println("Hallo");
	 * orgSceneX = t.getSceneX(); orgSceneY = t.getSceneY(); orgTranslateX =
	 * ((Label)(t.getSource())).getTranslateX(); orgTranslateY =
	 * ((Label)(t.getSource())).getTranslateY(); } }; EventHandler<MouseEvent>
	 * wuerfelOnMouseDraggedEventHandler = new EventHandler<MouseEvent>(){
	 * 
	 * @Override public void handle(MouseEvent t){ System.out.println("Hallo2");
	 * double offsetX = t.getSceneX() - orgSceneX; double offsetY =
	 * t.getSceneY() -orgSceneY; double newTranslateX = orgTranslateX+offsetX;
